...
async function detectOverflow(middlewareArguments, options) {
  ...
  const clippingClientRect = rectToClientRect(await platform.getClippingRect({
    element: (await (platform.isElement == null ? void 0 : platform.isElement(element))) ?? true ? element : element.contextElement || (await (platform.getDocumentElement == null ? void 0 : platform.getDocumentElement(elements.floating))),
    boundary,
    rootBoundary,
    strategy
  }));
